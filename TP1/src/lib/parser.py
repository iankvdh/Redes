...
class Parser:
    ...
    def _add_common_flags(self):
        ...
        self.parser.add_argument(
            "-p", "--port", type=int, default=8080, help="port server port"
        )
    ...
    def _add_download_args(self):
        self._add_common_flags()
        self._add_name_and_protocol()
        default_storage = os.path.join(os.getcwd(), "client_storage")
        self.parser.add_argument(
            "-d", "--dst", default=default_storage, help="destination file path"
        )
    ...
    def _add_server_args(self):
        ...
        self.parser.add_argument(
            ...
            help="storage path for received files",
        )
